 ...
 * Reuses existing login logic but locked to PSA role
 */
      ...
      <div className="relative w-full max-w-md mx-auto">
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden flex flex-col">
          <div className="p-10 w-full">
            <h2 className="text-2xl font-bold text-slate-800 text-center mb-4">Super Admin Login</h2>
            <p className="text-sm text-slate-500 text-center mb-6">Platform Super Administrator Access</p>
