            ...
            <div className="bg-white border-b border-slate-200 px-4 sm:px-6 py-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3 sm:gap-4">
                        <button
                            onClick={() => navigate('/hr/letter-templates')}
                            className="flex items-center gap-2 text-slate-600 hover:text-slate-800 flex-shrink-0"
                        >
                            <ArrowLeft size={18} />
                    ...
                    <div className="flex items-center gap-3">
                        {template?.templateType === 'WORD' && template?.hasFile !== false && (
                            <button
                                ...
                                className="flex-1 sm:flex-none flex items-center justify-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition font-medium"
                            >
                                <Download size={18} />
            ...
            <div className="flex-1 p-4 sm:p-6">
                {pdfUrl ? (
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        <iframe
                            src={pdfUrl}
                            className="w-full h-[calc(100vh-250px)] sm:h-[calc(100vh-200px)] border-0"
                            title="PDF Preview"
                        />
                    </div>
                ) : (
