                ...
                filteredEmployees.slice((currentPage - 1) * pageSize, currentPage * pageSize).map(emp => {
                  ...
                  return (
                    <tr key={emp._id} className="hover:bg-slate-50 dark:hover:bg-slate-900 transition">
                      ...
                      <td className="px-6 py-4 text-sm text-slate-600 dark:text-slate-400 whitespace-nowrap">{emp.email || '—'}</td>
                      <td className="px-6 py-4 text-sm text-slate-600 dark:text-slate-400 whitespace-nowrap">{emp.role || '—'}</td>
                      <td className="px-6 py-4 text-sm text-slate-600 dark:text-slate-400 whitespace-nowrap">{emp.department || '—'}</td>
