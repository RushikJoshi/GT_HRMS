            ...
            <div className="flex gap-3">
              ...
              <div className="text-xs text-blue-700 dark:text-blue-300 font-bold leading-relaxed space-y-2">
                <div>
                  ...
                  <span>First Name, Last Name, Email, Joining Date (YYYY-MM-DD format)</span>
                </div>
                <div>
                  <span className="font-black block mb-1">🔄 Auto-Generated if Blank:</span>
                  <span>Employee ID (format: EMP0001, EMP0002, etc.)</span>
                </div>
                <div>
