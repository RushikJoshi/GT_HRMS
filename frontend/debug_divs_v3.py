    ...
    for pos, type, text in events:
        ...
        if type == 'open':
            ...
            if not stack:
                ...
                if line_no > 2200 and line_no < 2400:
                    print(f"Line {line_no} closes div from line {last_open_line}")
    
    for line_no, pos in stack:
        print(f"Unclosed div opened at line {line_no}")

if __name__ == "__main__":
    debug_nesting_v3('c:/HRMS/frontend/src/pages/HR/Applicants.jsx')
