...
async function checkEmpSnap() {
    try {
        ...
        console.log('Employee currentSalarySnapshotId:', emp.currentSalarySnapshotId);
        console.log('Employee salarySnapshots:', emp.salarySnapshots);
